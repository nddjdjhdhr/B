...
stripe.api_key = "sk_test_51RFoFwQ08BSBpCMxsqQbX5fvfrEQU2W1m08bi95Z1Z0cuozwKeqtTVluzfG9uSuotGmtpt12ndkd1QDy9fJesmqp00ghDUotxw"
...
async def gen_cards(update: Update, context: ContextTypes.DEFAULT_TYPE):
    try:
        ...
        print("DEBUG API Response:", r.status_code, r.text)  # debug
